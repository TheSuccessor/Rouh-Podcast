...
export const translations = {
  en: {
    ...
    // Reset Confirm
    resetConfirm: "Are you sure you want to reset all prompts and content to defaults? This cannot be undone.",
  ...
  ar: {
    ...
    // Reset Confirm
    resetConfirm: "هل أنت متأكد من رغبتك في إعادة تعيين جميع التعليمات والمحتوى إلى الوضع الافتراضي؟ لا يمكن التراجع عن هذا الإجراء.",
